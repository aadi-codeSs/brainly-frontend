...
export const Card = (props: CardProps) => {
    ...
    return <div className="flex flex-col w-70 border-[#edf2f0] border-2 m-2 rounded-2xl h-[420px] h-full justify-between overflow-hidden">
        <CardHeader  type={props.type} title={props.headerTitle} deleteFn={props.deleteFn} contentId={props.contentId}></CardHeader>
        <div className="p-2 m-2 flex-1 overflow-hidden">
            ...
            <div className="text-sm text-[#333] max-h-42 overflow-hidden">
               <ReadMoreText text={props.description} limit={130}/>
            </div>
        </div>
