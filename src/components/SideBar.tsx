...
const defaultStyles = "fixed left-0 top-16 h-[calc(100vh-4rem)] w-56 flex flex-col gap-0.75 bg-[#f9fafd] rounded-br-xl z-20 max-md:hidden"
...
export const SideBar = () => {
    ...
    return <div className="">
        <aside className={`${defaultStyles}`}>
            ...
            <div className="flex items-center justify-center mt-135 mb-2!">
                
                <Button variant="primary" text="Logout" size="sm" additionalStyles="w-36" onClick={handleLogout} />
