...
const defaultStyles = "sticky top-0 min-h-[80vh] w-56 flex flex-col gap-0.75 bg-[#f9fafd] rounded-br-xl "
...
export const SideBar = () => {
    ...
    return <div className="">
        <aside className={`${defaultStyles}`}>
            ...
            <div className="flex items-center justify-center mt-120 mb-2!">
